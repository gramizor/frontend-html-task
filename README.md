...
# Тестовое задание
Активную ссылку сделал статичной, в полноценном проекте ее можно передавать из компонента как пропс, либо брать с помощью хука useNavigate
Так же добавил те же стили при клике на эту кнопку
